...
*Have you ever taken down a production database with an accidental N+1 query? (I know I have!) Share your horror stories in the comments! 👇*


and hashes, you can build a perfectly optimized data tree with a single line of code.
...
Fixing N+1 queries is usually the easiest way to make a slow Rails app feel 10x faster.
